...
public class MeshDestroyScript : MonoBehaviour
{
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroyScript original)
        {
            ...
            var meshDestroy = GameObject.AddComponent<MeshDestroyScript>();
